    ...
    return new Promise(resolve=>{
      ...
      s.onload=()=>{
        ...
        _tokenClient=google.accounts.oauth2.initTokenClient({client_id:CONFIG.CLIENT_ID,scope:CONFIG.SCOPES,
          callback:r=>{if(r.access_token){_token=r.access_token;localStorage.setItem('ws_token',_token);const u=_user||JSON.parse(localStorage.getItem('ws_user')||'null');App.onSignedIn(u,_token);}}});
