...
const Archivos={_cur:null,_crumb:[],render(el){
  el.innerHTML=`<div class="view active"><div class="ph"><div><div class="pt">Archivos</div><div class="psub">Carpeta compartida del equipo</div></div><div style="display:flex;gap:8px"><button class="btn" onclick="Archivos.nuevaCarpeta()">+ Nueva carpeta</button><button class="btn btnp" onclick="document.getElementById('fup').click()">↑ Subir archivo</button></div></div>
